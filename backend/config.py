...
MAX_DOCUMENT_CHARS = parse_int_env("MAX_DOCUMENT_CHARS", 50_000, min_value=1)
MAX_TOTAL_CHARS_PER_SEO_ANALYSIS = parse_int_env("MAX_TOTAL_CHARS_PER_SEO_ANALYSIS", 1_500_000, min_value=1)
MAX_TOTAL_CHARS_PER_SPELLING_ANALYSIS = parse_int_env("MAX_TOTAL_CHARS_PER_SPELLING_ANALYSIS", 1_500_000, min_value=1)
