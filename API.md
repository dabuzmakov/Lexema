...
| 400 | `SPELLING_DOCUMENT_TOO_LARGE` | Один документ для spelling больше `MAX_DOCUMENT_CHARS`. |
...
| Символов в одном документе | `50000` |
| Символов суммарно для SEO | `1500000` |
| Символов суммарно для spelling | `1500000` |
